<script lang="ts">
	...
	import { getFormData } from '$lib/utils/utils';
    import {Row, Col, Button, Container, Nav, NavItem, NavLink, Table, InputGroup, Input} from '@sveltestrap/sveltestrap';
		...
		{#each datas as data, index}
			<div class="kv-list">
				...
				<div class="kv-right">
					...
					<Button color="danger" type="button" form="kv-form" on:click={deleteHandler({id:index})}>Remove</Button>
				</div>
			</div>
		{/each}
		<div class="kv-form">
